...
const EmployeeListPage = (props) => {
	...
	function ActionButton(data){
		...
		{
			label: $t('view'),
			command: (event) => { app.navigate(`/employee/view/${data.employeeid}`) },
			icon: "pi pi-eye"
		},
		{
			label: $t('edit'),
			command: (event) => { app.navigate(`/employee/edit/${data.employeeid}`) },
			icon: "pi pi-pencil"
		},
		{
			label: $t('delete'),
	...
	function ReportstoTemplate(data){
		if(data){
			return (
				<>{data.reportsto && <Button className="p-button-text" icon="pi pi-eye" label={$t('employee')} onClick={() => app.openPageDialog(<EmployeeViewPage isSubPage apiPath={`/employee/view/${data.reportsto}`} />, {closeBtn: true })} /> }</>
			);
		}
	}
	...
	return (
<main id="EmployeeListPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container-fluid">
            <div className="grid justify-content-between align-items-center">
                <div className="col " >
                    <Title title={$t('employee')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
                <div className="col-fixed " >
                    <Link to={`/employee/add`}>
                        <Button label={$t('addNewEmployee')} icon="pi pi-plus" type="button" className="p-button w-full bg-primary "  />
                        </Link>
                    </div>
                        ...
                        <div >
                            ...
                            <div className="page-records">
                                <DataTable 
                                    ...
                                    <Column  field="reportsto" header={$t('reportsto')} body={ReportstoTemplate}  ></Column>
                                    <Column  field="birthdate" header={$t('birthdate')}   ></Column>
                                    <Column  field="hiredate" header={$t('hiredate')}   ></Column>
