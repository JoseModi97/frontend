...
const EmployeeAddPage = (props) => {
	...
	if(pageReady){
		return (
<main id="EmployeeAddPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title={$t('addNewEmployee')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
...
EmployeeAddPage.defaultProps = {
	primaryKey: 'employeeid',
	pageName: 'employee',
	apiPath: 'employee/add',
	routeName: 'employeeadd',
