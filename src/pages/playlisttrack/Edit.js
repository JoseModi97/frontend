...
const PlaylisttrackEditPage = (props) => {
		const app = useApp();
	...
	if(pageReady){
		return (
<main id="PlaylisttrackEditPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title={$t('editPlaylisttrack')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
...
PlaylisttrackEditPage.defaultProps = {
	primaryKey: 'playlistid',
	pageName: 'playlisttrack',
	apiPath: 'playlisttrack/edit',
	routeName: 'playlisttrackedit',
...
export default PlaylisttrackEditPage;
