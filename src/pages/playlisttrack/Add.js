...
const PlaylisttrackAddPage = (props) => {
		const app = useApp();
	...
	if(pageReady){
		return (
<main id="PlaylisttrackAddPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title={$t('addNewPlaylisttrack')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
...
PlaylisttrackAddPage.defaultProps = {
	primaryKey: 'playlistid',
	pageName: 'playlisttrack',
	apiPath: 'playlisttrack/add',
	routeName: 'playlisttrackadd',
...
export default PlaylisttrackAddPage;
