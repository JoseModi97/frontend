...
const PlaylistAddPage = (props) => {
	...
	if(pageReady){
		return (
<main id="PlaylistAddPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title={$t('addNewPlaylist')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
...
PlaylistAddPage.defaultProps = {
	primaryKey: 'playlistid',
	pageName: 'playlist',
	apiPath: 'playlist/add',
	routeName: 'playlistadd',
...
export default PlaylistAddPage;
