...
const MediatypeAddPage = (props) => {
	...
	if(pageReady){
		return (
<main id="MediatypeAddPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title={$t('addNewMediatype')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
...
MediatypeAddPage.defaultProps = {
	primaryKey: 'mediatypeid',
	pageName: 'mediatype',
	apiPath: 'mediatype/add',
	routeName: 'mediatypeadd',
...
export default MediatypeAddPage;
