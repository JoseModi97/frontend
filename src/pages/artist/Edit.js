...
const ArtistEditPage = (props) => {
	...
	if(pageReady){
		return (
<main id="ArtistEditPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title={$t('editArtist')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
...
ArtistEditPage.defaultProps = {
	primaryKey: 'artistid',
	pageName: 'artist',
	apiPath: 'artist/edit',
	routeName: 'artistedit',
