...
const CustomerViewPage = (props) => {
	...
	function ActionButton(data){
		...
		{
			label: $t('edit'),
			command: (event) => { app.openPageDialog(<CustomerEditPage isSubPage apiPath={`/customer/edit/${data.customerid}`} />, {closeBtn: true }) },
			icon: "pi pi-pencil"
		},
		{
			label: $t('delete'),
	...
	if(pageReady){
		return (
			<div>
<main id="CustomerViewPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title={$t('customerDetails')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div >
                        ...
                        <div className="mb-3 grid ">
                            ...
                            <div className="col-12 md:col-4">
                                <div className="card flex gap-3 align-items-center card shadow-none p-3 surface-100 ">
                                    <div className="">
                                        <div className="text-400 font-medium mb-1">{$t('company')}</div>
                            ...
                            <div className="col-12 md:col-4">
                                <div className="card flex gap-3 align-items-center card shadow-none p-3 surface-100 ">
                                    <div className="">
                                        <div className="text-400 font-medium mb-1">{$t('supportrepid')}</div>
                                        <div className="font-bold">{item.supportrepid && <Button className="p-button-text" icon="pi pi-eye" label={$t('employeeDetail')} onClick={() => app.openPageDialog(<EmployeeViewPage isSubPage apiPath={`/employee/view/${item.supportrepid}`} />, {closeBtn: true })} /> }</div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
CustomerViewPage.defaultProps = {
	id: null,
	primaryKey: 'customerid',
	pageName: 'customer',
	apiPath: 'customer/view',
