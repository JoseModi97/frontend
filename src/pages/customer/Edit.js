...
const CustomerEditPage = (props) => {
	...
	if(pageReady){
		return (
<main id="CustomerEditPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title={$t('editCustomer')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
...
CustomerEditPage.defaultProps = {
	...
	pageName: 'customer',
	apiPath: 'customer/edit',
	routeName: 'customeredit',
