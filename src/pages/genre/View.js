...
import GenreEditPage from 'pages/genre/Edit';
import useApp from 'hooks/useApp';

import useViewPage from 'hooks/useViewPage';
const GenreViewPage = (props) => {
		const app = useApp();
	...
	function ActionButton(data){
		...
		{
			label: $t('edit'),
			command: (event) => { app.openPageDialog(<GenreEditPage isSubPage apiPath={`/genre/edit/${data.genreid}`} />, {closeBtn: true }) },
			icon: "pi pi-pencil"
		},
		{
			label: $t('delete'),
	...
	if(pageReady){
		return (
			<div>
<main id="GenreViewPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title={$t('genreDetails')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
